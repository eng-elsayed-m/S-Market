    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Card(
          elevation: 7,
          child: ListTile(
            leading: CircleAvatar(backgroundImage: NetworkImage(product.imageUrl),radius: 35,),
            ...
            trailing: Container(
              ...
              child: Row(
                ...
                children: [
                IconButton(icon: Icon(Icons.edit,color: Color(0xFF30475e),), onPressed: ()=> Navigator.of(context).pushNamed(EditProductScreen.nav,arguments: product.id)),
